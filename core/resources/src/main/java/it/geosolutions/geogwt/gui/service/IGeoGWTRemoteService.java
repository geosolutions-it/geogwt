/*
 * $ Header:  it.geosolutions.geogwt.gui.service.IGeoGWTRemoteService,v. 0.1 18-apr-2012 16.59.50 created by tobia di pisa <tobia.dipisa at geo-solutions.it> $
...
/**
 * The Interface IGeoGWTRemoteService.
 * 
 * @author Tobia Di Pisa at tobia.dipisa@geo-solutions.it
 * 
 */
public interface IGeoGWTRemoteService {
     ...
     * @throws IOException
     */
    public GetFeatureInfoDetails getFeatures(String bounds, List<String> layersIDs, String crsCode)
            throws Exception;
